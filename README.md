...
Текущий автоматизированный гейт проверяет только узкий боевой сценарий: 300 видимых бойцов, не менее 59 FPS и не более 24 draw calls. Последний локальный прогон в Playwright Chromium показал 59,7 FPS, p95 16,9 мс и 12 draw calls. Полный целевой сценарий с 600 зданиями или сегментами, 2 000 жителей и 20 пожарами отдельно пока не измерен.
...
Это прототип вертикального среза, а не завершённая игра. Ближайшая продуктовая задача — углублять связку «развитие города → подготовка обороны → последствия набега», не превращая управление в полноценную RTS.
